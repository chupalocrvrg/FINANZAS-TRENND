...
**Siguiendo las pautas de impacto, esto constituye un incremento de tipo Nueva Característica con un ajuste leve subsecuente (Patch)**, elevándose progresivamente de **V5.2.1** a **V5.3.0** y luego a **V5.3.1** como versión final estabilizada.
